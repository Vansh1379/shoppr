        ...
        <>
            <div className='flex items-center bg-gray-400 pb-5 mt-5' >
                <div className='ml-10 mt-10'>
                    <div>
                        <img src={Ecom} alt='E-commerce logo' className='h-10 w-20' />
                    </div>
                    <div className='mt-3'>
                        <ul>
                ...
                <div className=' mx-16 mt-10'>
                    ...
                    <div>
                        <ul>
                            ...
                            <li className='text-white font-normal text-sm py-1 hover:text-pink-500'>Sell on E-commerce</li>
                        </ul>
                    </div>
                </div>
                <div className=' mx-16 mt-10'>
            ...
            <div className='bg-pink-500 h-14 text-white '>
